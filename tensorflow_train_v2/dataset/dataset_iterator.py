...
class DatasetIterator(DataGeneratorBase):
    ...
    def init_pipeline(self):
        ...
        data_pipeline = data_pipeline.prefetch(buffer_size=tf.data.AUTOTUNE)
    ...
    def get_next_data_entry(self):
        ...
        """
        current_dict = self.dataset.get_next(cache=self.cache)
        data_generators = current_dict['generators']
        return self.get_tf_data(data_generators)
