...
if __name__ == '__main__':
    ...
    base_output_folder = '/PATH/TO/experiments/multi_organ/bcv15_abdomen_4organs'

    dataset_name_train = 'bcv15_abdomen_4organs'
    train_modality = 'ct'
    ...
    for cur_params_dict in load_model_and_modality_list:
        ...
        wrapper_dict_list = [
            ...
            #         image_base_folder='images',
            #     ),
            #     dataset_folder_subpath='multi_organ/amos22_4organs_mr',
            #     has_validation_groundtruth=True,
            #     dataset_name_train=dataset_name_train,
            #     dataset_name_test='amos22_4organs_mr',
            #     modality='mr',
            # ),
            # --------------------------------------------------------
