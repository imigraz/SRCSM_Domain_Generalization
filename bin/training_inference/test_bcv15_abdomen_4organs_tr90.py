...
if __name__ == '__main__':
    ...
    base_output_folder = '/PATH/TO/experiments/multi_organ/bcv15_abdomen_4organs_tr90'

    dataset_name_train = 'bcv15_abdomen_4organs_tr90'
    train_modality = 'ct'
    ...
    for cur_params_dict in load_model_and_modality_list:
        ...
        wrapper_dict_list = [
            ...
            #     ),
            #     dataset_folder_subpath='multi_organ/chaos19_mr_t2_tr90',
            #     has_validation_groundtruth=True,
            #     dataset_name_train=dataset_name_train,
            #     dataset_name_test='chaos19_mr_t2_tr90',
            #     modality='mr',
            # ),
            # --------------------------------------------------------
