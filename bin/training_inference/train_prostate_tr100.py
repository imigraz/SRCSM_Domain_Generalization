...
if __name__ == '__main__':
    ...
    # set setup folder to the respective training domain
    # Note: in this setup, only a model trained on domain A is required for evaluation
    setup = 'setup_A' # 'setup_A', 'setup_B', 'setup_C', 'setup_D', 'setup_E', 'setup_F'

    base_dataset_folder = '/PATH/TO/datasets/prostate/prostate_tr100'
    base_output_folder = '/PATH/TO/experiments/prostate/prostate_tr100'
