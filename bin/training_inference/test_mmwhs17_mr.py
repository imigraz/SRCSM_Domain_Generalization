...
if __name__ == '__main__':
    ...
    base_output_folder = '/PATH/TO/experiments/heart/mmwhs17_mr'

    dataset_name_train = 'mmwhs17_mr'
    train_modality = 'mr'
    ...
    for cur_params_dict in load_model_and_modality_list:
        ...
        wrapper_dict_list = [
            ...
            #     ),
            #     dataset_folder_subpath='heart/mmwhs17_ct',
            #     has_validation_groundtruth=True,
            #     map_predictions_to_ventricles_only=False,
            #     dataset_name_train=dataset_name_train,
            #     dataset_name_test='mmwhs17_ct',
            #     modality='ct',
            # ),
            # --------------------------------------------------------
