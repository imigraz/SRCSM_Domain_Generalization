...
def match_mmwhs_ct_to_rest(base_input_path, base_output_path, output_dtype, output_ext, use_multiprocessing, percentage_cpu_cores):
    ...
    average_cdf_list = [mmwhs_mr_average_cdf]
    for cur_average_cdf in average_cdf_list:
        perform_histogram_matching(
            src_parameter_dataset=mmwhs_ct_dataset,
...
def match_mmwhs_mr_to_rest(base_input_path, base_output_path, output_dtype, output_ext, use_multiprocessing, percentage_cpu_cores):
    ...
    average_cdf_list = [mmwhs_ct_average_cdf]
    for cur_average_cdf in average_cdf_list:
        perform_histogram_matching(
            src_parameter_dataset=mmwhs_mr_dataset,
            dst_parameter_dataset=cur_average_cdf,
            output_path=base_output_path,
            output_dtype=output_dtype,
            output_ext=output_ext,
...
def main():
    ...
    match_mmwhs_ct_to_rest(in_base_path, out_base_path, output_dtype, output_ext, use_multiprocessing, percentage_cpu_cores)
    match_mmwhs_mr_to_rest(in_base_path, out_base_path, output_dtype, output_ext, use_multiprocessing, percentage_cpu_cores)
