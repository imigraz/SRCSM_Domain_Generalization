...
def compute_and_save_average_cdf(base_input_path):
    ...
    amos22_4organs_ct_train_dataset = Dataset(
    ...
    amos22_4organs_ct_train_dataset.process_data_and_compute_average_cdf(save_average_cdf=True)

    amos22_4organs_mr_train_dataset = Dataset(
    ...
    amos22_4organs_mr_train_dataset.process_data_and_compute_average_cdf(save_average_cdf=True)
