...
def match_prostate_tr90_to_rest(base_input_path, base_output_path, output_dtype, output_ext, use_multiprocessing, percentage_cpu_cores):
    ...
    for test_setup in all_setups:
        for train_setup in all_setups:
            ...
            prostate_dataset_test = Dataset(
                base_dataset_path=os.path.join(base_input_path, 'prostate_tr90'),
                modality='mr',
                image_suffix='_image',
                image_ext='.nii.gz',
            ...
            for cur_average_cdf in average_cdf_list:
                perform_histogram_matching(
                    ...
                    image_output_path=os.path.join(base_output_path, 'prostate_tr90', f'images_as_{train_setup}'),
                )
    return
...
def main():
    ...
    match_prostate_tr90_to_rest(in_base_path, out_base_path, output_dtype, output_ext, use_multiprocessing, percentage_cpu_cores)
