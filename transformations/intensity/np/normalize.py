...
def normalize_robust(img, out_range=(-1, 1), consideration_factors=(0.1, 0.1), ignore_value=None):
    """
    ...
    if ignore_value is not None:
        tmp = img[img!=ignore_value]
    else:
        tmp = img

    min_value, max_value = robust_min_max(tmp, consideration_factors)
